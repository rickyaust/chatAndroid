...
public class FirebaseHelper {
    ...
    //private final static String FIREBASE_URL = "https://android-chat-richard.firebaseio.com";
    //private final static String FIREBASE_URL = "https://dazzling-torch-3222.firebaseio.com";

    private final static String FIREBASE_URL="https://android-chat-rickcor.firebaseio.com";
    //private final static String FIREBASE_URL="https://android-example-chat.firebaseio.com";
    ...
    private void notifyContactsOfConnectionChange(final boolean online, final boolean singoff) {
        ...
        getMyContactsReference().addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnaphsot) {
